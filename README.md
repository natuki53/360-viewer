...
1. このプラグインをZIPファイルとしてダウンロードします
   - [360-viewer-1.1.1.zip](releases/360-viewer-1.1.1.zip) - 最新版（推奨）
   - [360-viewer-1.1.0.zip](releases/360-viewer-1.1.0.zip) - 1.1系初版
   - [360-viewer-1.0.2.zip](releases/360-viewer-1.0.2.zip) - 1.0系最終版
   - [360-viewer-1.0.1.zip](releases/360-viewer-1.0.1.zip) - 不具合修正版
...
- `<version>` は `package.json` の `version` を使用
- macOS / Windows 両対応（`bash`や`zip`コマンド不要）
