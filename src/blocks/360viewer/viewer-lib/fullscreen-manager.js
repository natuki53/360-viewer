...
export class FullscreenManager {
    ...
    exitFullscreen() {
        ...
        if (this.originalParent) {
            ...
            this.viewer.container.style.backgroundColor = this.originalBackground;
            this.viewer.container.style.paddingTop = '56.25%';
            this.viewer.container.style.maxWidth = '';
            this.viewer.container.style.maxHeight = '';
            
            if (this.originalNextSibling) {
                this.originalParent.insertBefore(this.viewer.container, this.originalNextSibling);
            } else {
